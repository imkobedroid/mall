...
import mall.kotlin.com.goodcenter.event.CartAllCheckedEvent
import mall.kotlin.com.goodcenter.event.UpdateCartSizeEvent
import mall.kotlin.com.goodcenter.event.UpdateTotalPriceEvent
import mall.kotlin.com.goodcenter.injection.component.DaggerCartComponent
import mall.kotlin.com.goodcenter.injection.module.CartModule
import mall.kotlin.com.goodcenter.presenter.CartListPresenter
import mall.kotlin.com.goodcenter.presenter.view.CartListView
import mall.kotlin.com.goodcenter.ui.adapter.CartGoodsAdapter
...
class CartFragment : BaseMvpFragment<CartListPresenter>(), CartListView {
    ...
    override fun onGetCartListResult(result: MutableList<CartGoods>?) {
        ...
        //本地存储并发送事件刷新UI
        AppPrefsUtils.putInt(GoodConstant.SP_CART_SIZE,result?.size?:0)
